...
from dataset.data_reader import CTDataset,MRDataset
...
def main():
    ...
    if cfg.TRAIN.SNAPSHOT_DIR == '':
        ...
        # cfg.TRAIN.SNAPSHOT_DIR = osp.join('/home/data_backup/lyn', cfg.EXP_NAME)
    ...
    # DataLoaders
    # train_mr_data_pth = '/home/zhr/MPSCL/data/datalist/train_mr2ct_cyclegan_65epoch.txt'
    train_mr_data_pth = '/home/zhr/MPSCL/data/datalist/train_mr.txt'
    train_ct_data_pth = '/home/zhr/MPSCL/data/datalist/train_ct.txt'
    train_mr_gt_pth   = '/home/zhr/MPSCL/data/datalist/gt_train_mr.txt'
    train_ct_gt_pth   = '/home/zhr/MPSCL/data/datalist/gt_train_ct.txt'
    val_mr_data_pth   = '/home/zhr/MPSCL/data/datalist/val_mr.txt'
    val_ct_data_pth   = '/home/zhr/MPSCL/data/datalist/val_ct.txt'
    val_mr_gt_pth     = '/home/zhr/MPSCL/data/datalist/gt_val_mr.txt'
    val_ct_gt_pth     = '/home/zhr/MPSCL/data/datalist/gt_val_ct.txt'
    ...
    if cfg.SOURCE == 'MR':
        ...
        strain_loader_ = data.DataLoader(strain_dataset,
                                        batch_size=cfg.TRAIN.BATCH_SIZE,
                                        num_workers=cfg.NUM_WORKERS,
                                        shuffle=True,
                                        pin_memory=True,
    ...
    # UDA TRAINING
    train_domain_adaptation(model, ema_model, strain_loader, trgtrain_loader, sval_loader, cfg, strain_loader_)
