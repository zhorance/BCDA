...
# Exp dirs
cfg.EXP_NAME          = ''
cfg.EXP_ROOT          =  '/home/zhr/CVPR_TMI_new/scripts/experiments'
...
cfg.TRAIN.EMA_RESTORE_FROM     = ''
cfg.TRAIN.UPDATE_CENTER_METHOD = 'iter'
cfg.TRAIN.D_TYPE               = 'Original_D'
cfg.TRAIN.THRESHOLD            = 0.95
cfg.TRAIN.MIXMETHOD            = 'CUT'
cfg.TRAIN.CONSWITCH            = 1
# Class info
